...
export default function FacebookIcon(props: any) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={classNames(props.className)} viewBox="0 0 20 20">
      <g id="Symbols" stroke="none" stroke-width="1" fill="currentColor" fill-rule="evenodd">
          <g id="footer/idle" transform="translate(-120.000000, -130.000000)">
              <rect fill="#F5F6F6" x="0" y="0" width="1440" height="522"/>
              <g id="Icon/facebook" transform="translate(120.000000, 130.000000)" fill="currentColor">
