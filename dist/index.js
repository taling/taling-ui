...
__export(src_exports, {
  ...
  AnimatedToggleButtonComponent: () => AnimatedToggleButtonComponent,
  AppCookieConstants: () => app_cookie_default,
  AppleIcon: () => AppleIcon,
  ApplicationPaymentType: () => ApplicationPaymentType,
  ApplicationRefundStatus: () => ApplicationRefundStatus,
  ApplicationStatus: () => ApplicationStatus,
  ApplicationTutorStatus: () => ApplicationTutorStatus,
  Autocomplete: () => Autocomplete,
  BasicSkeletonComponent: () => BasicSkeletonComponent,
  BlogIcon: () => BlogIcon,
  Button: () => Button,
  CalendarDay: () => day_default,
  CalendarEvent: () => event_default,
  CalendarHeader: () => header_default,
  CalendarInterface: () => components_default,
  CalendarViewMode: () => CalendarViewMode,
  CheckBox: () => CheckBox,
  Checkbox: () => Checkbox,
  Chip: () => Chip,
  ClipboardListIconOutline: () => ClipboardListIconOutline,
  ClipboardListIconSolid: () => ClipboardListIconSolid,
  DateSource: () => DateSource,
  DefaultProgressBarComponent: () => DefaultProgressBarComponent,
  DevMarker: () => dev_marker_default,
  Dialog: () => Dialog2,
  DialogButtons: () => DialogButtons,
  DynamicLineHeight: () => dynamic_line_height_default,
  FacebookIcon: () => FacebookIcon,
  GROUP_CLASS: () => GROUP_CLASS,
  ImageFallback: () => ImageFallback,
  ImageSkeletonComponent: () => ImageSkeletonComponent,
  Input: () => Input,
  ...
  LoadingBannerComponent: () => LoadingBannerComponent,
  LoadingSpinner: () => LoadingSpinner,
  LogoComponent: () => logo_default,
  ...
  NaverTrackingLoader: () => NaverTrackingLoader,
  ...
  Switch: () => Switch,
  TailwindCalendarComponent: () => calendar_default,
  TalentCategory: () => TalentCategory,
  TalentSchedule: () => talent_schedule_default,
  TalentSpecialRegion: () => TalentSpecialRegion,
  TalentStatus: () => TalentStatus,
  TalentStatusEnum: () => TalentStatusEnum,
  TalentType: () => TalentType,
  TalingAppContext: () => TalingAppContext,
  TalingAppIsPreviewVersionContext: () => TalingAppIsPreviewVersionContext,
  TalingLogoWithOutTM: () => TalingLogoWithOutTM,
  TemplateIconOutline: () => TemplateIconOutline,
  ...
  appPrefix: () => appPrefix,
  assertRunningAsClient: () => assertRunningAsClient,
  buttonVariants: () => buttonVariants,
  classNames: () => classNames,
  cn: () => cn,
  colorPresets: () => colorPresets,
  devMarkerStore: () => devMarkerStore,
  filterKspayForbiddenChar: () => filterKspayForbiddenChar,
  ...
  toast: () => toast2,
  useCrossDomainCookies: () => useCrossDomainCookies,
  useIsVisible: () => useIsVisible,
  useNaverPixel: () => useNaverPixel,
  useTalingPixel: () => useTalingPixel,
  useToast: () => useToast
});
...
function Autocomplete({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "relative z-30" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        import_react2.Combobox.Options,
        {
          className: classNames(
...
function AnimatedToggleButtonComponent({
  ...
  var _a2, _b;
  const [isUpdating, setIsUpdating] = (0, import_react4.useState)(false);
  const [showErrorRender, setShowErrorRender] = (0, import_react4.useState)(false);
  return /* @__PURE__ */ React.createElement(import_framer_motion.AnimatePresence, null, isOn ? /* @__PURE__ */ React.createElement(
    ...
    isUpdating ? /* @__PURE__ */ React.createElement(import_framer_motion.motion.div, { ..._DefaultToggleAnimateProps, key: "button-on-spin" }, render.loading) : /* @__PURE__ */ React.createElement(import_framer_motion.motion.div, { ..._DefaultToggleAnimateProps, key: "button-on-on" }, showErrorRender ? (_a2 = render.error) != null ? _a2 : render.on : render.on)
  ) : /* @__PURE__ */ React.createElement(
    import_framer_motion.motion.div,
    {
      ..._DefaultToggleAnimateProps,
...
function WaitingButton({
  ...
  const [currentRender, setCurrentRender] = (0, import_react5.useState)(normal);
  const [isLoading, setIsLoading] = (0, import_react5.useState)(false);
  const _internalOnClick = (0, import_react5.useCallback)(async () => {
    if (isLoading) return;
    setIsLoading(true);
  ...
  const updateNormalButton = (0, import_react5.useCallback)(() => {
    if (!isLoading) {
  ...
  return (0, import_react5.cloneElement)(element, {
...
var MainColorContext = (0, import_react6.createContext)("pink");
...
var CalendarDayComponent = ({
  ...
  var _a2, _b;
  const mainColor = (0, import_react7.useContext)(MainColorContext);
...
var CalendarHeader = ({
  ...
  const mainColor = (0, import_react9.useContext)(MainColorContext);
  const color = colorPresets[mainColor];
  return /* @__PURE__ */ React.createElement("header", { className: "flex items-center justify-between border-b border-gray-200 py-2 sm:py-2 lg:flex-none 2xl:py-4 " }, /* @__PURE__ */ React.createElement("h1", { className: "text-xl font-medium leading-6 text-gray-900 sm:text-xl 2xl:text-2xl" }, /* @__PURE__ */ React.createElement("time", { dateTime: `${selectedYear}-${selectedMonth}` }, selectedYear, "\uB144 ", selectedMonth, "\uC6D4")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React.createElement("div", { className: "relative flex items-center rounded-md bg-white shadow-sm md:items-stretch" }, /* @__PURE__ */ React.createElement(
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "hidden md:flex md:items-center" }, useViewMode && /* @__PURE__ */ React.createElement(import_react8.Menu, { as: "div", className: "relative md:ml-4 " }, /* @__PURE__ */ React.createElement(
    import_react8.Menu.Button,
    {
      type: "button",
    ...
    /* @__PURE__ */ React.createElement(import_react8.Menu.Items, { className: "absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" }, /* @__PURE__ */ React.createElement("div", { className: "py-1" }, /* @__PURE__ */ React.createElement(import_react8.Menu.Item, null, ({ active }) => /* @__PURE__ */ React.createElement(
      "a",
      {
        href: "#",
        className: classNames(
      ...
      "\uC8FC\uAC04"
    )), /* @__PURE__ */ React.createElement(import_react8.Menu.Item, null, ({ active }) => /* @__PURE__ */ React.createElement(
      "a",
      {
        href: "#",
        className: classNames(
...
var TailwindCalendarComponent = (0, import_react10.forwardRef)(
  ({
    eventSource,
    option,
    renderers,
    ...
    const [reloadTrigger, setReloadTrigger] = (0, import_react10.useState)(0);
    const [internalViewMode, setInternalViewMode] = (0, import_react10.useState)(
      "month" /* Month */
    );
    const [selectedYear, setSelectedYear] = (0, import_react10.useState)(
      defaultSelectedYear ? defaultSelectedYear : (/* @__PURE__ */ new Date()).getFullYear()
    );
    const [selectedMonth, setSelectedMonth] = (0, import_react10.useState)(
      defaultSelectedMonth ? defaultSelectedMonth : (/* @__PURE__ */ new Date()).getMonth() + 1
    );
    const [selectedWeekInYear, setSelectedWeekInYear] = (0, import_react10.useState)(
      DateSource.getWeekInYear(/* @__PURE__ */ new Date())
    );
    const [daysInMonth, setDaysInMonth] = (0, import_react10.useState)({
      days: [],
      isSixWeeks: false
    });
    const [eventMappedDaysInMonth, setEventMappedDaysInMonth] = (0, import_react10.useState)([]);
    const loadDaysInMonth = (0, import_react10.useCallback)(() => {
    ...
    const loadAndMapEvents = (0, import_react10.useCallback)(
      async (daysInMonth2) => {
        var _a2;
    ...
    const nextMonth = (0, import_react10.useCallback)(() => {
    ...
    const prevMonth = (0, import_react10.useCallback)(() => {
      setSelectedMonth(selectedMonth - 1);
      if (selectedMonth === 1) {
        setSelectedYear(selectedYear - 1);
        setSelectedMonth(12);
...
// src/components/dev-marker/index.tsx
var DevMarker = () => {
  const [isShowing, setIsShowing] = (0, import_react11.useState)(false);
  const appContext = (0, import_react11.useContext)(TalingAppContext);
  const [isDev, setIsDev] = (0, import_react11.useState)(false);
  const [devMsag, setDevMsg] = (0, import_react11.useState)(
...
var DynamicLineHeightText = ({
  ...
  const [isSingleLine, setIsSingleLine] = (0, import_react12.useState)(true);
...
function ImageFallback({
  ...
  const [showFallback, setShowFallback] = (0, import_react13.useState)(false);
  if (showFallback || !src) {
    if (useDefaultImg) {
...
function DefaultProgressBarComponent({ percent }) {
  const [_internalPercent, setInternalPercent] = (0, import_react16.useState)(0);
...
function SelectBox({
  ...
  const [_internaList, setInternalList] = (0, import_react18.useState)();
  const [selected, setSelected] = (0, import_react18.useState)(null);
  const [_hydrated, setHydrated] = (0, import_react18.useState)(false);
  const onListChanged = (0, import_react18.useCallback)(
    (newList) => {
    ...
    ({ open }) => {
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: classNames("relative", width) }, /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2" }, /* @__PURE__ */ React.createElement(
          import_solid2.ChevronUpDownIcon,
          {
        ...
        /* @__PURE__ */ React.createElement(
          import_react17.Listbox.Options,
          {
            className: classNames(
...
var TalingAppIsPreviewVersionContext = (0, import_react19.createContext)({
...
var import_react20 = require("@headlessui/react");
function Dialog2({
  title,
  subTitle,
  children,
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(import_react20.DialogPanel, { className: "flex flex-col gap-6 w-[18.4375rem] bg-taling-white p-5 rounded-xl shadow-strong" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-5" }, /* @__PURE__ */ React.createElement(import_react20.DialogTitle, { className: "flex flex-col gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "text-body1normal-bold text-strong" }, title), /* @__PURE__ */ React.createElement("span", { className: "text-label1reading-regular text-neutral" }, subTitle)), children && /* @__PURE__ */ React.createElement("section", null, children)), /* @__PURE__ */ React.createElement(
      DialogButtons,
      {
        cancelLabel,
        confirmLabel,
...
function InputField({
  ...
  const [filteredLength, setFilteredLength] = (0, import_react22.useState)(0);
...
function TextareaField({
  ...
  const [filteredLength, setFilteredLength] = (0, import_react23.useState)(0);
  const lengthInfo = maxLength ? `(${filteredLength}/${maxLength})` : void 0;
...
function Modal({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(import_react24.DialogTitle, { className: "flex flex-col gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-heading3-semibold text-neutral" }, title), /* @__PURE__ */ React.createElement("span", { className: "text-label1reading-regular text-neutral" }, subTitle)),
...
var PopoverContent = import_react25.default.forwardRef(
  ({
    children,
    ...props
  }, forwardedRef) => /* @__PURE__ */ import_react25.default.createElement(PopoverPrimitive.Portal, null, /* @__PURE__ */ import_react25.default.createElement(
    ...
    children,
    /* @__PURE__ */ import_react25.default.createElement(PopoverPrimitive.Arrow, { className: "fill-white" })
  ))
);
...
var ToastClose = React5.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React5.createElement(
  ...
  /* @__PURE__ */ React5.createElement(import_react_icons2.Cross2Icon, { className: "h-4 w-4" })
));
...
var toastIcons = {
  default: import_solid3.CheckCircleIcon,
  warning: import_solid3.ExclamationTriangleIcon,
  error: import_solid3.XCircleIcon
};
...
var Toaster = () => /* @__PURE__ */ React.createElement(import_react_hot_toast2.Toaster, null);
...
var snackbar = {
  show: ({ description, duration = 4e3, label, onClick }) => {
    return import_react_hot_toast3.toast.custom(
      (t) => /* @__PURE__ */ React.createElement(
        CustomSnackbar,
        {
          description,
...
function useIsVisible(ref) {
  const [isIntersecting, setIntersecting] = (0, import_react27.useState)(null);
  const [isIntersectingStart, setIntersectingStart] = (0, import_react27.useState)(
    null
  );
