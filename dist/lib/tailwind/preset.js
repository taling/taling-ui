...
exports.default = {
    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                normal: "0px 1px 2px 0px rgba(0, 0, 0, 0.12), 0px 0px 1px 0px rgba(0, 0, 0, 0.08), 0px 0px 1px 0px rgba(0, 0, 0, 0.08)",
                emphasize: "0px 2px 8px 0px rgba(0, 0, 0, 0.12), 0px 1px 4px 0px rgba(0, 0, 0, 0.08), 0px 0px 1px 0px rgba(0, 0, 0, 0.08)",
                strong: " 0px 6px 12px 0px rgba(0, 0, 0, 0.12), 0px 4px 8px 0px rgba(0, 0, 0, 0.08), 0px 0px 4px 0px rgba(0, 0, 0, 0.08)",
                heavy: "0px 16px 20px 0px rgba(0, 0, 0, 0.12), 0px 8px 16px 0px rgba(0, 0, 0, 0.08), 0px 0px 8px 0px rgba(0, 0, 0, 0.08)",
            },
            keyframes: {
                "accordion-down": {
                    from: { height: "0px" },
            ...
            animation: {
                ...
                "slide-out-bottom": "slide-out-bottom 0.2s cubic-bezier(0.4, 0, 0.2, 1)",
            },
            fontSize: {
                "display1-bold": [
                    "2.5rem",
