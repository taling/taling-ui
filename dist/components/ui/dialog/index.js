...
function Dialog({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(import_react2.DialogPanel, { className: "flex flex-col gap-6 w-[18.4375rem] bg-taling-white p-5 rounded-xl shadow-strong" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-5" }, /* @__PURE__ */ React.createElement(import_react2.DialogTitle, { className: "flex flex-col gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "text-body1normal-bold text-strong" }, title), /* @__PURE__ */ React.createElement("span", { className: "text-label1reading-regular text-neutral" }, subTitle)), children && /* @__PURE__ */ React.createElement("section", null, children)), /* @__PURE__ */ React.createElement(
      DialogButtons,
      {
        cancelLabel,
        confirmLabel,
